...
import { Lock, Loader2, CheckCircle, Sparkles, Sun, Moon, Menu, X, ArrowLeft } from "lucide-react";
    ...
    return (
      <div className={`min-h-screen transition-colors duration-300 ${bgColor} flex items-center justify-center p-4`}>
        ...
        >
          ...
          <h2 className={`text-4xl font-bold mb-4 ${textPrimary}`}>Password Reset!</h2>
        ...
        <div className="max-w-md w-full">
          ...
          >
            <form onSubmit={handleResetPassword} className="space-y-5">
              ...
              <div>
                <label className={`block ${textPrimary} mb-2 text-sm font-medium`}>New Password</label>
              ...
              <div>
                <label className={`block ${textPrimary} mb-2 text-sm font-medium`}>Confirm New Password</label>
                <div className="relative">
                  <Lock className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-slate-500" />
                  <input
                    type="password"
          ...
          >
            <p className={`text-xs ${textMuted}`}>
              <span className="font-bold text-emerald-600">Secure password reset</span> • Your account security matters
            </p>
          </motion.div>
        </div>
      </div>
